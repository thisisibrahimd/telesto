{
  ...
  spec: {
    '#configMapRef':: d.obj(help='"model from configmap"'),
    configMapRef: {
    ...
    envs: {
      ...
      '#withValue':: d.fn(help='"Inline env value"', args=[d.arg(name='value', type=d.T.string)]),
    ...
    '#oci':: d.obj(help='"model from an OCI artifact (e.g. ghcr.io/team/dashboards:v1)"'),
    oci: {
      '#pullSecretRef':: d.obj(help='"PullSecretRef references a kubernetes.io/dockerconfigjson Secret in the same namespace as the CR.\\nIf omitted, anonymous pull is attempted."'),
      pullSecretRef: {
        '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { oci+: { pullSecretRef+: { name: name } } } },
      },
      '#withInsecurePlainHTTP':: d.fn(help='"InsecurePlainHTTP switches the registry connection to plain HTTP (non-TLS) instead of HTTPS.\\nIntended for in-cluster or test registries; HTTPS registries with self-signed\\ncertificates are not supported. Default false."', args=[d.arg(name='insecurePlainHTTP', type=d.T.boolean)]),
      withInsecurePlainHTTP(insecurePlainHTTP): { spec+: { oci+: { insecurePlainHTTP: insecurePlainHTTP } } },
      '#withPath':: d.fn(help='"Path is the path of the file to extract from the artifact."', args=[d.arg(name='path', type=d.T.string)]),
      withPath(path): { spec+: { oci+: { path: path } } },
      '#withReference':: d.fn(help='"Reference is the full OCI artifact reference including a tag or digest,\\ne.g. \\"ghcr.io/team/dashboards:v1.4.7\\" or\\n\\"ghcr.io/team/dashboards@sha256:abc123...\\". Prefer a digest for\\nreproducible deployments."', args=[d.arg(name='reference', type=d.T.string)]),
      withReference(reference): { spec+: { oci+: { reference: reference } } },
    },
    ...
    '#publicSharing':: d.obj(help='"Allows configuration of sharing the dashboard publicly"'),
    publicSharing: {
      '#withAccessToken':: d.fn(help='"Optional. Unique access token. If empty it will generate a new access token per instance."', args=[d.arg(name='accessToken', type=d.T.string)]),
      withAccessToken(accessToken): { spec+: { publicSharing+: { accessToken: accessToken } } },
      '#withAnnotationsEnabled':: d.fn(help='"Optional. When set to true, shows annotations. The default value is false."', args=[d.arg(name='annotationsEnabled', type=d.T.boolean)]),
      withAnnotationsEnabled(annotationsEnabled): { spec+: { publicSharing+: { annotationsEnabled: annotationsEnabled } } },
      '#withEnabled':: d.fn(help='"Optional. Set to false to disable sharing, the public dashboard is still created. The default value is true."', args=[d.arg(name='enabled', type=d.T.boolean)]),
      withEnabled(enabled): { spec+: { publicSharing+: { enabled: enabled } } },
      '#withTimeSelectionEnabled':: d.fn(help='"Optional. when set to true, the time picker is enabled in the shared dashboard. The default value is false."', args=[d.arg(name='timeSelectionEnabled', type=d.T.boolean)]),
      withTimeSelectionEnabled(timeSelectionEnabled): { spec+: { publicSharing+: { timeSelectionEnabled: timeSelectionEnabled } } },
    },
    '#urlAuthorization':: d.obj(help='"authorization options for model from url"'),
    urlAuthorization: {
    ...
    '#variables':: d.obj(help='"overrides the default (current) value of named template variables in the dashboard model.\\nVariables that are not present in the model are ignored."'),
    variables: {
      '#withName':: d.fn(help='"Name of the template variable to override, matching templating.list[].name in the model."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { name: name },
      '#withValue':: d.fn(help='"Value is the new default value. For datasource variables this is the datasource UID or\\nname; for query, custom, constant and textbox variables it is the selected value.\\nMulti-value (multi-select) variables are collapsed to this single value."', args=[d.arg(name='value', type=d.T.string)]),
      withValue(value): { value: value },
    },
    ...
    '#withContentCacheDuration':: d.fn(help='"Cache duration for models fetched from URLs"', args=[d.arg(name='contentCacheDuration', type=d.T.string)]),
    ...
    '#withGzipJson':: d.fn(help="\"GzipJson the model's JSON compressed with Gzip. Base64-encoded when in YAML.\"", args=[d.arg(name='gzipJson', type=d.T.string)]),
    withGzipJson(gzipJson): { spec+: { gzipJson: gzipJson } },
    '#withJson':: d.fn(help='"model json"', args=[d.arg(name='json', type=d.T.string)]),
    ...
    '#withUid':: d.fn(help='"Manually specify the uid, overwrites uids already present in the json model.\\nCan be any string consisting of alphanumeric characters, - and _ with a maximum length of 40."', args=[d.arg(name='uid', type=d.T.string)]),
    withUid(uid): { spec+: { uid: uid } },
    '#withUrl':: d.fn(help='"model url"', args=[d.arg(name='url', type=d.T.string)]),
    withUrl(url): { spec+: { url: url } },
    '#withVariables':: d.fn(help='"overrides the default (current) value of named template variables in the dashboard model.\\nVariables that are not present in the model are ignored."', args=[d.arg(name='variables', type=d.T.array)]),
    withVariables(variables): { spec+: { variables: if std.isArray(v=variables) then variables else [variables] } },
    '#withVariablesMixin':: d.fn(help='"overrides the default (current) value of named template variables in the dashboard model.\\nVariables that are not present in the model are ignored."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='variables', type=d.T.array)]),
