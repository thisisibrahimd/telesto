{
  ...
  '#':: d.pkg(name='grafanaLibraryPanel', url='', help='"GrafanaLibraryPanel is the Schema for the grafanalibrarypanels API"'),
  ...
  '#new':: d.fn(help='new returns an instance of GrafanaLibraryPanel', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'grafana.integreatly.org/v1beta1',
    kind: 'GrafanaLibraryPanel',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"GrafanaLibraryPanelSpec defines the desired state of GrafanaLibraryPanel"'),
  spec: {
