{
  ...
  '#':: d.pkg(name='cluster', url='', help='"Cluster defines the API schema for a highly available PostgreSQL database cluster\\nmanaged by CloudNativePG."'),
  ...
  spec: {
    ...
    backup: {
      ...
      barmanObjectStore: {
        ...
        azureCredentials: {
          ...
          '#withUseDefaultAzureCredentials':: d.fn(help='"Use the default Azure authentication flow, which includes DefaultAzureCredential.\\nThis allows authentication using environment variables and managed identities."', args=[d.arg(name='useDefaultAzureCredentials', type=d.T.boolean)]),
          withUseDefaultAzureCredentials(useDefaultAzureCredentials): { spec+: { backup+: { barmanObjectStore+: { azureCredentials+: { useDefaultAzureCredentials: useDefaultAzureCredentials } } } } },
        },
    ...
    bootstrap: {
      ...
      recovery: {
        ...
        recoveryTarget: {
          ...
          '#withTargetTime':: d.fn(help='"The target time as a timestamp in RFC3339 format or PostgreSQL timestamp format.\\nTimestamps without an explicit timezone are interpreted as UTC."', args=[d.arg(name='targetTime', type=d.T.string)]),
    ...
    externalClusters: {
      ...
      barmanObjectStore: {
        ...
        azureCredentials: {
          ...
          '#withUseDefaultAzureCredentials':: d.fn(help='"Use the default Azure authentication flow, which includes DefaultAzureCredential.\\nThis allows authentication using environment variables and managed identities."', args=[d.arg(name='useDefaultAzureCredentials', type=d.T.boolean)]),
          withUseDefaultAzureCredentials(useDefaultAzureCredentials): { barmanObjectStore+: { azureCredentials+: { useDefaultAzureCredentials: useDefaultAzureCredentials } } },
        },
        '#data':: d.obj(help='"The configuration to be used to backup the data files\\nWhen not defined, base backups files will be stored uncompressed and may\\nbe unencrypted in the object store, according to the bucket default\\npolicy."'),
        data: {
          '#withAdditionalCommandArgs':: d.fn(help="\"AdditionalCommandArgs represents additional arguments that can be appended\\nto the 'barman-cloud-backup' command-line invocation. These arguments\\nprovide flexibility to customize the backup process further according to\\nspecific requirements or configurations.\\n\\nExample:\\nIn a scenario where specialized backup options are required, such as setting\\na specific timeout or defining custom behavior, users can use this field\\nto specify additional command arguments.\\n\\nNote:\\nIt's essential to ensure that the provided arguments are valid and supported\\nby the 'barman-cloud-backup' command, to avoid potential errors or unintended\\nbehavior during execution.\"", args=[d.arg(name='additionalCommandArgs', type=d.T.array)]),
      ...
      plugin: {
        ...
        '#withIsWALArchiver':: d.fn(help='"Marks the plugin as the WAL archiver. At most one plugin can be\\ndesignated as a WAL archiver. This cannot be enabled if the\\n`.spec.backup.barmanObjectStore` configuration is present."', args=[d.arg(name='isWALArchiver', type=d.T.boolean)]),
    ...
    monitoring: {
      ...
      '#withEnablePodMonitor':: d.fn(help='"Enable or disable the `PodMonitor`\\n\\nDeprecated: This feature will be removed in an upcoming release. If\\nyou need this functionality, you can create a PodMonitor manually."', args=[d.arg(name='enablePodMonitor', type=d.T.boolean)]),
      withEnablePodMonitor(enablePodMonitor): { spec+: { monitoring+: { enablePodMonitor: enablePodMonitor } } },
      '#withMetricsQueriesTTL':: d.fn(help='"The interval during which metrics computed from queries are considered current.\\nOnce it is exceeded, a new scrape will trigger a rerun\\nof the queries.\\nIf not set, defaults to 30 seconds, in line with Prometheus scraping defaults.\\nSetting this to zero disables the caching mechanism and can cause heavy load on the PostgreSQL server."', args=[d.arg(name='metricsQueriesTTL', type=d.T.string)]),
      withMetricsQueriesTTL(metricsQueriesTTL): { spec+: { monitoring+: { metricsQueriesTTL: metricsQueriesTTL } } },
      '#withPodMonitorMetricRelabelings':: d.fn(help='"The list of metric relabelings for the `PodMonitor`. Applied to samples before ingestion.\\n\\nDeprecated: This feature will be removed in an upcoming release. If\\nyou need this functionality, you can create a PodMonitor manually."', args=[d.arg(name='podMonitorMetricRelabelings', type=d.T.array)]),
      ...
      '#withPodMonitorRelabelings':: d.fn(help='"The list of relabelings for the `PodMonitor`. Applied to samples before scraping.\\n\\nDeprecated: This feature will be removed in an upcoming release. If\\nyou need this functionality, you can create a PodMonitor manually."', args=[d.arg(name='podMonitorRelabelings', type=d.T.array)]),
    ...
    podSecurityContext: {
      ...
      withSeLinuxChangePolicy(seLinuxChangePolicy): { spec+: { podSecurityContext+: { seLinuxChangePolicy: seLinuxChangePolicy } } },
      ...
      withSupplementalGroupsPolicy(supplementalGroupsPolicy): { spec+: { podSecurityContext+: { supplementalGroupsPolicy: supplementalGroupsPolicy } } },
    ...
    postgresql: {
      ...
      extensions: {
        ...
        '#withBin_path':: d.fn(help="\"A list of directories within the image to be appended to the\\nPostgreSQL process's `PATH` environment variable.\"", args=[d.arg(name='bin_path', type=d.T.array)]),
        withBin_path(bin_path): { bin_path: if std.isArray(v=bin_path) then bin_path else [bin_path] },
        '#withBin_pathMixin':: d.fn(help="\"A list of directories within the image to be appended to the\\nPostgreSQL process's `PATH` environment variable.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='bin_path', type=d.T.array)]),
        withBin_pathMixin(bin_path): { bin_path+: if std.isArray(v=bin_path) then bin_path else [bin_path] },
        ...
        '#withName':: d.fn(help="\"The name of the extension, required. The limit of 59 characters\\nleaves room for the prefix the operator adds when deriving the\\nextension's Kubernetes Volume name (capped at 63 characters).\"", args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
      },
      ...
      withExtensions(extensions): { spec+: { postgresql+: { extensions: if std.isArray(v=extensions) then extensions else [extensions] } } },
      ...
      withExtensionsMixin(extensions): { spec+: { postgresql+: { extensions+: if std.isArray(v=extensions) then extensions else [extensions] } } },
    ...
    '#primaryLease':: d.obj(help='"Configuration of the Kubernetes `Lease` used to coordinate safe primary\\nelection within the cluster. When omitted, the operator applies built-in\\ndefaults; tune these values only if you understand the consequences for\\nfailover timing."'),
    primaryLease: {
      '#withLeaseDurationSeconds':: d.fn(help='"How long, in seconds, the primary lease is considered valid before it\\nexpires and another instance may acquire it. It must be greater than\\n`renewDeadlineSeconds`.\\nDefaults to 15."', args=[d.arg(name='leaseDurationSeconds', type=d.T.integer)]),
      withLeaseDurationSeconds(leaseDurationSeconds): { spec+: { primaryLease+: { leaseDurationSeconds: leaseDurationSeconds } } },
      '#withReleasedLeaseDurationSeconds':: d.fn(help='"The TTL, in seconds, written when the primary explicitly releases the\\nlease on a clean shutdown, allowing a replica to promote without waiting\\nfor the full lease duration to expire.\\nDefaults to 1."', args=[d.arg(name='releasedLeaseDurationSeconds', type=d.T.integer)]),
      withReleasedLeaseDurationSeconds(releasedLeaseDurationSeconds): { spec+: { primaryLease+: { releasedLeaseDurationSeconds: releasedLeaseDurationSeconds } } },
      '#withRenewDeadlineSeconds':: d.fn(help='"How long, in seconds, the current primary keeps retrying to renew the\\nlease before giving up and stopping. It must be smaller than\\n`leaseDurationSeconds`.\\nDefaults to 10."', args=[d.arg(name='renewDeadlineSeconds', type=d.T.integer)]),
      withRenewDeadlineSeconds(renewDeadlineSeconds): { spec+: { primaryLease+: { renewDeadlineSeconds: renewDeadlineSeconds } } },
      '#withRetryPeriodSeconds':: d.fn(help='"How frequently, in seconds, a non-holder instance retries acquiring or\\nrenewing the lease.\\nDefaults to 2."', args=[d.arg(name='retryPeriodSeconds', type=d.T.integer)]),
      withRetryPeriodSeconds(retryPeriodSeconds): { spec+: { primaryLease+: { retryPeriodSeconds: retryPeriodSeconds } } },
    },
    ...
    probes: {
      ...
      liveness: {
        '#isolationCheck':: d.obj(help='"Configure the feature that extends the liveness probe for a primary\\ninstance. In addition to the basic checks, this verifies whether the\\nprimary is isolated from the Kubernetes API server and from its\\nreplicas, ensuring that it can be safely shut down if network\\npartition or API unavailability is detected. Enabled by default."'),
        isolationCheck: {
          '#withConnectionTimeout':: d.fn(help='"Timeout in milliseconds for connections during the primary isolation check"', args=[d.arg(name='connectionTimeout', type=d.T.integer)]),
          withConnectionTimeout(connectionTimeout): { spec+: { probes+: { liveness+: { isolationCheck+: { connectionTimeout: connectionTimeout } } } } },
          '#withEnabled':: d.fn(help='"Whether primary isolation checking is enabled for the liveness probe"', args=[d.arg(name='enabled', type=d.T.boolean)]),
          withEnabled(enabled): { spec+: { probes+: { liveness+: { isolationCheck+: { enabled: enabled } } } } },
          '#withRequestTimeout':: d.fn(help='"Timeout in milliseconds for requests during the primary isolation check"', args=[d.arg(name='requestTimeout', type=d.T.integer)]),
          withRequestTimeout(requestTimeout): { spec+: { probes+: { liveness+: { isolationCheck+: { requestTimeout: requestTimeout } } } } },
        },
    ...
    replicationSlots: {
      ...
      highAvailability: {
        ...
        '#withSynchronizeLogicalDecoding':: d.fn(help='"When enabled, the operator automatically manages synchronization of logical\\ndecoding (replication) slots across high-availability clusters.\\n\\nRequires one of the following conditions:\\n- PostgreSQL version 17 or later\\n- PostgreSQL version < 17 with pg_failover_slots extension enabled"', args=[d.arg(name='synchronizeLogicalDecoding', type=d.T.boolean)]),
        withSynchronizeLogicalDecoding(synchronizeLogicalDecoding): { spec+: { replicationSlots+: { highAvailability+: { synchronizeLogicalDecoding: synchronizeLogicalDecoding } } } },
      },
    ...
    '#securityContext':: d.obj(help="\"Override the SecurityContext applied to every Container in the Pod of the cluster.\\nWhen set, this overrides the operator's default Container SecurityContext.\\nIf omitted, the operator defaults are used.\""),
    securityContext: {
