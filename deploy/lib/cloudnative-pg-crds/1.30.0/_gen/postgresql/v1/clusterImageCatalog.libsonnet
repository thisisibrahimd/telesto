{
  ...
  '#':: d.pkg(name='clusterImageCatalog', url='', help='"ClusterImageCatalog is the Schema for the clusterimagecatalogs API"'),
  ...
  '#new':: d.fn(help='new returns an instance of ClusterImageCatalog', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
