{
  ...
  '#':: d.pkg(name='databaseRole', url='', help='"DatabaseRole is the Schema for the databaseroles API"'),
  ...
  '#new':: d.fn(help='new returns an instance of DatabaseRole', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'postgresql.cnpg.io/v1',
    kind: 'DatabaseRole',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"Specification of the desired DatabaseRole.\\nMore info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status"'),
  spec: {
    '#clientCertificate':: d.obj(help="\"ClientCertificate configures the operator to generate and renew a TLS client\\ncertificate for this role, signed by the cluster's client CA. The certificate\\nis stored in a Secret named `\u003cdatabaserole-name\u003e-client-cert`.\\nRequires login to be true.\""),
    clientCertificate: {
      '#withEnabled':: d.fn(help='"Enabled turns on client certificate issuance for this role. When true,\\nthe role must have login enabled. Defaults to true when the block is present."', args=[d.arg(name='enabled', type=d.T.boolean)]),
      withEnabled(enabled): { spec+: { clientCertificate+: { enabled: enabled } } },
    },
    '#cluster':: d.obj(help='"The corresponding cluster"'),
    cluster: {
    ...
    passwordSecret: {
      ...
      withName(name): { spec+: { passwordSecret+: { name: name } } },
    },
    ...
    withBypassrls(bypassrls): { spec+: { bypassrls: bypassrls } },
    '#withComment':: d.fn(help='"Description of the role"', args=[d.arg(name='comment', type=d.T.string)]),
    withComment(comment): { spec+: { comment: comment } },
    ...
    withCreatedb(createdb): { spec+: { createdb: createdb } },
    ...
    withCreaterole(createrole): { spec+: { createrole: createrole } },
    '#withDatabaseRoleReclaimPolicy':: d.fn(help='"The policy for end-of-life maintenance of this role"', args=[d.arg(name='databaseRoleReclaimPolicy', type=d.T.string)]),
    withDatabaseRoleReclaimPolicy(databaseRoleReclaimPolicy): { spec+: { databaseRoleReclaimPolicy: databaseRoleReclaimPolicy } },
    ...
    withDisablePassword(disablePassword): { spec+: { disablePassword: disablePassword } },
    ...
    withInRoles(inRoles): { spec+: { inRoles: if std.isArray(v=inRoles) then inRoles else [inRoles] } },
    ...
    withInRolesMixin(inRoles): { spec+: { inRoles+: if std.isArray(v=inRoles) then inRoles else [inRoles] } },
    ...
    withInherit(inherit): { spec+: { inherit: inherit } },
    ...
    withLogin(login): { spec+: { login: login } },
    ...
    withSuperuser(superuser): { spec+: { superuser: superuser } },
    ...
    withValidUntil(validUntil): { spec+: { validUntil: validUntil } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
