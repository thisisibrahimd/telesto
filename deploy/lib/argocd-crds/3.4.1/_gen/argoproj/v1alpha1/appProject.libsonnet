{
  ...
  '#':: d.pkg(name='appProject', url='', help='"AppProject provides a logical grouping of applications, providing controls for:\\n* where the apps may deploy to (cluster whitelist)\\n* what may be deployed (repository whitelist, resource whitelist/blacklist)\\n* who can access these applications (roles, OIDC group claims bindings)\\n* and what they can do (RBAC policies)\\n* automation access to these roles (JWT tokens)"'),
  ...
  spec: {
    ...
    clusterResourceBlacklist: {
      ...
      '#withName':: d.fn(help="\"Name is the name of the restricted resource. Glob patterns using Go's filepath.Match syntax are supported.\\nUnlike the group and kind fields, if no name is specified, all resources of the specified group/kind are matched.\"", args=[d.arg(name='name', type=d.T.string)]),
    ...
    '#destinationServiceAccounts':: d.obj(help='"DestinationServiceAccounts holds information about the service accounts to be impersonated for the application sync operation for each destination."'),
    destinationServiceAccounts: {
      '#withDefaultServiceAccount':: d.fn(help='"DefaultServiceAccount to be used for impersonation during the sync operation"', args=[d.arg(name='defaultServiceAccount', type=d.T.string)]),
      withDefaultServiceAccount(defaultServiceAccount): { defaultServiceAccount: defaultServiceAccount },
      '#withNamespace':: d.fn(help="\"Namespace specifies the target namespace for the application's resources.\"", args=[d.arg(name='namespace', type=d.T.string)]),
      withNamespace(namespace): { namespace: namespace },
      '#withServer':: d.fn(help="\"Server specifies the URL of the target cluster's Kubernetes control plane API.\"", args=[d.arg(name='server', type=d.T.string)]),
    ...
    '#withDestinationServiceAccounts':: d.fn(help='"DestinationServiceAccounts holds information about the service accounts to be impersonated for the application sync operation for each destination."', args=[d.arg(name='destinationServiceAccounts', type=d.T.array)]),
    withDestinationServiceAccounts(destinationServiceAccounts): { spec+: { destinationServiceAccounts: if std.isArray(v=destinationServiceAccounts) then destinationServiceAccounts else [destinationServiceAccounts] } },
    '#withDestinationServiceAccountsMixin':: d.fn(help='"DestinationServiceAccounts holds information about the service accounts to be impersonated for the application sync operation for each destination."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='destinationServiceAccounts', type=d.T.array)]),
    withDestinationServiceAccountsMixin(destinationServiceAccounts): { spec+: { destinationServiceAccounts+: if std.isArray(v=destinationServiceAccounts) then destinationServiceAccounts else [destinationServiceAccounts] } },
