{
  ...
  '#':: d.pkg(name='imageCatalog', url='', help='"ImageCatalog is the Schema for the imagecatalogs API"'),
  ...
  '#new':: d.fn(help='new returns an instance of ImageCatalog', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
