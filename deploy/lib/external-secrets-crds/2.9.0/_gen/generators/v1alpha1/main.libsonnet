{
  ...
  beyondtrustWorkloadCredentialsDynamicSecret: (import 'beyondtrustWorkloadCredentialsDynamicSecret.libsonnet'),
  ...
  gitlabDeployToken: (import 'gitlabDeployToken.libsonnet'),
