{
  ...
  spec: {
    ...
    syncWindows: {
      ...
      withKind(kind): { spec+: { syncWindows+: { kind: kind } } },
      '#withWindows':: d.fn(help='"Windows is the list of schedule+duration pairs."', args=[d.arg(name='windows', type=d.T.array)]),
      withWindows(windows): { spec+: { syncWindows+: { windows: if std.isArray(v=windows) then windows else [windows] } } },
      ...
      withWindowsMixin(windows): { spec+: { syncWindows+: { windows+: if std.isArray(v=windows) then windows else [windows] } } },
    },
    ...
    target: {
      ...
      manifest: {
        ...
        withApiVersion(apiVersion): { spec+: { target+: { manifest+: { apiVersion: apiVersion } } } },
        '#withKind':: d.fn(help='"Kind of the target resource (e.g., \\"ConfigMap\\", \\"Application\\")"', args=[d.arg(name='kind', type=d.T.string)]),
        withKind(kind): { spec+: { target+: { manifest+: { kind: kind } } } },
      },
      ...
      template: {
        ...
        metadata: {
          ...
          withFinalizers(finalizers): { spec+: { target+: { template+: { metadata+: { finalizers: if std.isArray(v=finalizers) then finalizers else [finalizers] } } } } },
          '#withFinalizersMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='finalizers', type=d.T.array)]),
          withFinalizersMixin(finalizers): { spec+: { target+: { template+: { metadata+: { finalizers+: if std.isArray(v=finalizers) then finalizers else [finalizers] } } } } },
    ...
    withRefreshPolicy(refreshPolicy): { spec+: { refreshPolicy: refreshPolicy } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
