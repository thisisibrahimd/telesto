    ...
    externalSecretSpec: {
      ...
      target: {
        ...
        template: {
          ...
          templateFrom: {
            '#configMap':: d.obj(help='"TemplateRef defines a reference to a template source in a ConfigMap or Secret."'),
            configMap: {
              ...
              items: {
                ...
                withKey(key): { key: key },
                '#withTemplateAs':: d.fn(help='"TemplateScope defines the scope of the template when processing template data."', args=[d.arg(name='templateAs', type=d.T.string)]),
            ...
            '#secret':: d.obj(help='"TemplateRef defines a reference to a template source in a ConfigMap or Secret."'),
            secret: {
              '#items':: d.obj(help='"A list of keys in the ConfigMap/Secret to use as templates for Secret data"'),
              items: {
                '#withKey':: d.fn(help='"A key in the ConfigMap/Secret"', args=[d.arg(name='key', type=d.T.string)]),
            ...
            '#withTarget':: d.fn(help='"TemplateTarget defines the target field where the template result will be stored."', args=[d.arg(name='target', type=d.T.string)]),
          ...
          '#withMergePolicy':: d.fn(help='"TemplateMergePolicy defines how template values should be merged when generating a secret."', args=[d.arg(name='mergePolicy', type=d.T.string)]),
