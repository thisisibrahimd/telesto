...
func NewServer(cfg *PublicServerConfig, svcs *services.Services, logger *server.Logger) *PublicServer {
	...
	router.Group(func(r chi.Router) {
		...
		r.Get("/telestos/{id}/edit", http.HandlerFunc(telestoHandler.EditTelesto))
		r.Put("/telestos/{id}/edit", http.HandlerFunc(telestoHandler.EditTelestoSubmit))
		...
		r.Get("/tokens/{id}/edit", http.HandlerFunc(tokenHandler.EditToken))
		r.Put("/tokens/{id}/edit", http.HandlerFunc(tokenHandler.EditTokenSubmit))
